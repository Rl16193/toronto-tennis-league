...
| `matches`            | `claimed_winner_*`, `score_line`              | **strip** — after functions _and_ hosting are out                                                                  | conflicts §Dropped                                                      | [Sprint D5](../sprints/SPRINT-D5.md) |
...
| `stats`              | `loses`                                       | **not stored** — derived as `matchesPlayed − wins`. **Both writers stop**: result deltas _and_ friendly payout     | [S1](HARMONIZATION_REPORT.md#S1)                                        | [Sprint D3](../sprints/SPRINT-D3.md) |
...
## 14 · Scheduling _([P3](WORKFLOW_DESIGN_REPORT.md#P3), [Sprint D4](../sprints/SPRINT-D4.md))_
