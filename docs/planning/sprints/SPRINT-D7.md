...
| [CS-17](../../archive/planning-2026-08-23/ACTION-REPORT.md#CS-17)   | `initialOf()`; avatars at exactly two sizes, **24 in player rows and 96 on the profile card** (owner ruling 2026-08-31). **Every player row carries a 24px avatar before the name**                                                                                                                                                                                                                                                                                                                                                                                                                                             | three first-initial implementations         |
