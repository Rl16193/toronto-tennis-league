...
| Row | Build | Retires |
| --- | --- | --- |
| **[CS-1](../../archive/planning-2026-08-23/ACTION-REPORT.md#CS-1)** | `formatPersonName` — merge `formatPlayerName` and `toTitleCase` | two formatters |
...
| [CS-7](../../archive/planning-2026-08-23/ACTION-REPORT.md#CS-7) | One `ProfileCard` with `mode: 'own' \| 'public'` | **two 700-line components already drifting** — the same field reads `Phone` in one and `Contact` in the other. The safety boundary is the rules file, not the component |
...
| [MF-9](../../archive/planning-2026-08-23/ACTION-REPORT.md#MF-9) | `AlertMessage` becomes the **only** banner — **1 consumer against 13 hand-rolled copies, 11 with no box at all and none announcing to a screen reader** |
| [MF-10](../../archive/planning-2026-08-23/ACTION-REPORT.md#MF-10) | `ConfirmSheet`; replace the remaining four browser `confirm()` dialogs |
...
| [BT-17](../../archive/planning-2026-08-23/ACTION-REPORT.md#BT-17) **then** [BT-9](../../archive/planning-2026-08-23/ACTION-REPORT.md#BT-9)/[BT-10](../../archive/planning-2026-08-23/ACTION-REPORT.md#BT-10) | **Order matters** — widen the gaps *before* growing the targets, or the upper control silently steals the lower one's taps mid-sweep |
