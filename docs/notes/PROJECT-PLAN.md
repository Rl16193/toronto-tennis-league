...
| **Working branch**  | `dev-anuj` @ `9325b3a` — Sprint D2 implementation merged from isolated `codex/sprint-2-d2`; no production deployment or data mutation                                                                                                                         |
...
| **Status**          | Sprint D1 and Sprint D2 are merged on `dev-anuj`; staging remains deferred until an authorized project and recovery path exist.                                                                                                                               |
