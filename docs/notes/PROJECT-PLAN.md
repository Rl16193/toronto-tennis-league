...
| **Working branch**  | `dev-anuj` @ `05b454e` — Sprint D4 implementation merged from isolated `codex/sprint-4-d4`; no production deployment or data mutation                                                                                                                         |
...
| **Status**          | Sprint D1 through Sprint D4 are merged on `dev-anuj`; staging remains deferred until an authorized project and recovery path exist.                                                                                                                          |
