...
| **Working branch**  | `codex/sprint-2-d2` (isolated from `dev-anuj` @ `5cdacee`) — Sprint D2 implementation in review; no production deployment or data mutation                                                                                                                    |
...
| **Status**          | Sprint D1 is merged on `dev-anuj`; Sprint D2 is implemented on its isolated branch and awaiting final merge review.                                                                                                                                           |
