...
| **Working branch**  | `dev-anuj` @ `a92be2d` — Sprint D3 implementation merged from isolated `codex/sprint-3-d3`; no production deployment or data mutation                                                                                                                         |
...
| **Status**          | Sprint D1, Sprint D2, and Sprint D3 are merged on `dev-anuj`; staging remains deferred until an authorized project and recovery path exist.                                                                                                                   |
