...
| Moderate | No repository rules-test harness or backup/recovery procedure is checked in. | Authorization and recovery readiness cannot be regression-tested or demonstrated from the checkout. |
