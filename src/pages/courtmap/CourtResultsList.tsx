...
// Memoized: CourtMap re-renders on every search keystroke, and this list re-rendered every
// filtered court each time even though its props (a memoized array + a useCallback) hadn't changed.
export const CourtResultsList: React.FC<Props> = React.memo(({ courts, loading, userCoords, onSelectCourt }) => {
  if (loading) {
    return (
