...
const buildDrawSvg = (matches: TournamentMatch[], drawTitle: string, drawState?: string): string => {
  ...
  ${drawState ? `<text x="${width / 2}" y="46" text-anchor="middle" font-family="Montserrat,Arial,sans-serif" font-size="11" font-weight="700" fill="#6b7280" letter-spacing="2">${escapeSvg(drawState.toUpperCase())}</text>` : ''}
